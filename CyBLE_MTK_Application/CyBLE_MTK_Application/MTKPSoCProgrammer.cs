            ...
            else
            {
                if (SelectedProgrammer != "")
                {
                    ...
                    ReturnString = "Programmer Action: " + ProgrammerAction
                        ...
                        + " | Programming Mode: " + SelectedAquireMode
        ...
        public override bool SetTestParameter(int TestParameterIndex, string ParameterValue)
        {
            ...
            switch (TestParameterIndex)
            {
                ...
                case 3:
                    ...
                    for (int i = 0; i < ProgrammerSupportedAquireMode.Count; i++)
                    {
                        if (ProgrammerSupportedAquireMode[i] == ParameterValue)
                        {
                            SelectedAquireMode = ProgrammerSupportedAquireMode[i];
                            return true;
                        }
                    }
                    return false;
